//
//  SemanticUnderstandingViewController.m
//  PhotoSelectDemo
//
...
@interface SemanticUnderstandingViewController ()
...
@implementation SemanticUnderstandingViewController
...
{
    self.title = CustomLocalizedString(@"understandingTitle", nil);
